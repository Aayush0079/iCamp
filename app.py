...
offer valid for - 7 days'''
    ...
    with tabs[2]:
        ...
        client_id = '1dc03029-d157-425b-a792-b801601c6e4d'
        tenant_id = '23d06903-f24d-4124-899f-5d907f55d8e1'
        client_secret = '8Z48Q~5iLUHg0A95NRMSSPLAvjog7~f1Vf4i8cEx'
        # Get this from Storage account > JSON view > BLOB
        account_url = 'https://llm9490398261.blob.core.windows.net/'
        ...
        filename = 'Model Guidelines.xlsx'

        # Load the model guidelines File from Azure ADLS account
        def get_model_guidelines(filename, container_name = 'icampaign-design', blob_name = 'Model Guidelines.xlsx'):
